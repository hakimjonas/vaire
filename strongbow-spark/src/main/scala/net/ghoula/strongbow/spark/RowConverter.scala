...
object RowConverter {
  ...
  /** Convert Strongbow-encoded values to the representation Spark expects at Row boundaries,
    * recursing into struct/array/map layouts.
    */
  ...
  /** Convert Spark Row values to Strongbow-encoded values, recursing into struct/array/map layouts.
    */
