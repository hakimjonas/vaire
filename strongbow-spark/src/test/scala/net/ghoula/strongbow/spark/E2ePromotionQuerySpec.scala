...
/** TPC-H Q14 proof-of-concept: strongbow Dataset plan vs native Spark SQL.
  *
...
class E2ePromotionQuerySpec extends AnyFlatSpec with Matchers with SparkTestBase with SlowTests {
  ...
  "TPC-H Q14" should "produce identical results via strongbow and native Spark" in {
    ...
    // Note: strongbow collects individual rows and sums on driver, native Spark aggregates
