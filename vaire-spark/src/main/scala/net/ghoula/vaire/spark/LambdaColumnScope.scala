...
import net.ghoula.vaire.expr.Binder

/** Lambda-variable bindings for the Spark conversion of a higher-order expression body, mirroring
  * [[net.ghoula.vaire.interpreter.LambdaScope]]: higher-order arms bind each
  * [[net.ghoula.vaire.expr.Binder]] to the fresh lambda-variable column handed back by Spark's
